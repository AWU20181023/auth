...
/**
 * Created by 260152(AWU) on 2018/10/27 13:49.
 */
public class CookieUtils {
     ...
     */
    public static void addCookie(HttpServletResponse res, String name, String value, String domain, int maxAge, boolean ifRemember) {
        try {
    ...
    private static String getValue(Cookie cookie) {
